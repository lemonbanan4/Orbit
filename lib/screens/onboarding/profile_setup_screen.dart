    ...
    return _buildInputTemplate(
      ...
      inputWidget: TextField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(color: const Color(0xFF1A1F36).withValues(alpha: 0.3), fontSize: 24, fontWeight: FontWeight.bold),
        ...
        children: [
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              disabledBackgroundColor: const Color(0xFF1A1F36).withValues(alpha: 0.3),
              ...
              child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: isSelected ? const Color(0xFFFFD600) : const Color(0xFF1A1F36).withValues(alpha: 0.3), width: 2),
                  ),
