// USING ONBOARDING_SCREEN FOR THIS !!!! --------------------------
...
//       context,
//       MaterialPageRoute(
//         builder: (context) => ContractScreen(userName: finalName),
//       ),
//     );
//   }
...
//           hintText: 'Enter your name', // Corrected withOpacity
//           hintStyle: TextStyle(
...
//                   value: _optOutEmails,
//                   onChanged: (val) =>
//                       setState(() => _optOutEmails = val ?? false),
//                   side: const BorderSide(color: Color(0xFF1A1F36), width: 2),
...
//               const Text(
//                 'Please do not send me motivational emails.',
...
//   Widget _buildSelectionTemplate({
//     required String title,
//     String? subtitle,
...
//                   width: isCentered
//                       ? 400
//                       : double.infinity, // Center layout for times
//                   margin: isCentered
